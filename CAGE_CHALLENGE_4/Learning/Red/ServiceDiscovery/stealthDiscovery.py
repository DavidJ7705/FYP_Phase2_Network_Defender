...
# mac: venv/bin/python -m Learning.Red.ServiceDiscovery.stealthDiscovery
# windows: .\venv\Scripts\python -m Learning.Red.ServiceDiscovery.stealthDiscovery
...
from CybORG.Simulator.Actions import StealthServiceDiscovery, Sleep
