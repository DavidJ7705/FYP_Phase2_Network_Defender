...
# mac: venv/bin/python -m Learning.Red.Impact.red_impact
# windows: .\venv\Scripts\python -m Learning.Red.Impact.red_impact
...
from CybORG.Simulator.Actions.AbstractActions import ExploitRemoteService, Impact
...
action = PrivilegeEscalate(hostname='contractor_network_subnet_server_host_0', session=0, agent=red_agent_name)
cyborg.step(agent=red_agent_name, action=action)
cyborg.step(agent=red_agent_name, action=Sleep())
